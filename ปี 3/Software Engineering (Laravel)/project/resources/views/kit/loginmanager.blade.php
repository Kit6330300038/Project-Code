...
<body>
    <div>
      ...
      <div class="header" style="background-color: #b40000 ;">
        <img src="assets/images/lg.png" alt="Stickman" width="156" height="65" style="padding-top: 8px; margin-left:10px;"/>
        <div class="header-right">
          
          <h1 style="margin-left: 155px; font-size: 30px; position:relative; top: -25px;" >เข้าสู่ระบบสำหรับผู้จัดการ</h1>

          <a href="{{route('login')}}" style="margin-left: 140px; font-size: 20px;" >ผู้ใช้ทั่วไป</a>
          <a href="{{route('loginwd')}}" style="margin-left: 30px; font-size: 20px;">ผู้ดูแลตู้</a>
          <a class="active" href="{{route('loginmg')}}" style="margin-left: 30px; font-size: 20px;">ผู้จัดการ</a>

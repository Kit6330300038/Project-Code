    ...
    <div>
      ...
      <div class="header" style="background-color: #000000 ;">
        ...
        <div class="header-right">
          ...
          <h1 style="margin-left: 250px; font-size: 30px; position:relative; top: -25px;" >เข้าสู่ระบบ</h1>

          <a class="active" href="{{route('login')}}" style="margin-left: 233px; font-size: 20px;" >ผู้ใช้ทั่วไป</a>

...
<body>
    ...
    <div class="sidebar">
        <div class="menucreate d-grid gap-2 text-center ">
            <ul>
                ...
                <li><a class ="sidebar-a_active" href="{{route('editindex')}}" data-text="archives">เปลี่ยนผู้ดูแลตู้</a></li>
    ...
    <div class="containeredit-center">
                    ...
                    <div class="row">
                        <!--<div class="col-md-12">
                            <div class="form-group my-3">
                                <strong>ID พนักงาน</strong>
                                <input type="number" name="id" value="{{$company->id}}" class="form-control0" placeholder="ID" min='6000'>
                                @error('id')
                        ...
                        <div class="col-md-12">
                            <div class="form-group my-3">
                                ...
                                <input type="text" name="name" value="{{$company->name}}" class="form-control0" placeholder="ชื่อ">
                                @error('name')
                                    <div class="lert alert-danger">{{$message}}</div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group my-3">
                                ...
                                <input type="text" name="surname" value="{{$company->surname}}" class="form-control0" placeholder="นามสกุล">
                                @error('surname')
                                    <div class="lert alert-danger">{{$message}}</div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group my-3">
                                <strong>EMAIL</strong>
                                <input type="email" name="username" value="{{$company->username}}" class="form-control0" placeholder="Email">
                                @error('username')
                                    <div class="lert alert-danger">{{$message}}</div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group my-3">
                                ...
                                <input type="text" name="password" value="{{$company->password}}" class="form-control0" placeholder="password">
                                @error('password')
                                    <div class="lert alert-danger">{{$message}}</div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group my-3">
                                ...
                                <input type="number"  name="idswappies" value="{{$company->idswappies}}" class="form-control0" placeholder="หมายเลข ID ตู้" min="500000" >
                                @error('idswappies')
                                    <div class="lert alert-danger">{{$message}}</div>
                        ...
                        <!--<div class="col-md-12">
                            <div class="form-group my-3">
                                ...
                                <input type="text" name="address" value="{{$company->address}}" class="form-control0" placeholder="สถานที่ตั้งตู้">
                                @error('address')
                                    <div class="lert alert-danger">{{$message}}</div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group my-3">
                                ...
                                <input type="tel" name="phone" value="{{$company->phone}}" class="form-control0" placeholder="เบอร์โทรศัพท์">
                                @error('phone')
                                    <div class="lert alert-danger">{{$message}}</div>

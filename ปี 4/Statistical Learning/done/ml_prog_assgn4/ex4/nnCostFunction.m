...
J=(1/m)*(sum(sum((-1*y_vector).* log(h_theta))-sum((1-y_vector).*log(1-h_theta))));
...
tridelt_1=tridelt_1+(delta_2')*(a1);
tridelt_2=tridelt_2+(delta_3')*(a2);


Theta1_grad = tridelt_1 / m;
Theta2_grad = tridelt_2 / m;
